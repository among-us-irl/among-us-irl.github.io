...
var Html5QrcodeScanner = function() {
    ...
    return _createClass(a, [{
        ...
        value: function(a) {
            a.style.position = "relative", a.style.padding = "0px", a.style.border = "none", this.__createHeader(a);
            var b = document.createElement("div"),
                c = this.__getScanRegionId();
            b.id = c, b.style.width = "100%", b.style.height = "100%", b.style.textAlign = "center", b.style.border = "none", a.appendChild(b), this.__insertCameraScanImageToScanRegion();
        ...
        value: function() {
			...
			g.classList.add("camera-check-launcher");
        ...
        value: function(b) {
            ...
            */
			...
			var priorityCamera = -1;
            for (var g = 0; g < b.length; g++) {
                let labl = b[g]["label"].toUpperCase();
				if (labl.includes("BACK") || labl.includes("REAR") || labl.includes("RÜCK") || labl.includes("MULTI")) {
                    // code below
					priorityCamera = g;
                     var h = b[g],
                        j = h.id,
            ...
            if (priorityCamera != -1) {
				f.options[priorityCamera].selected = true;
				// TODO set camera to priority camera
            } else {
				cameraController.style.display = "block";
			}
            ...
            o.innerHTML = "Stop Scanning", o.style.display = "none", o.disabled = !0, m.appendChild(o), d.appendChild(m), n.addEventListener("click", function() {
                ...
                b.disabled = !0, c.html5Qrcode.stop().then(function() {
                    c._showHideScanTypeSwapLink(!0), f.disabled = !1, n.disabled = !1, b.style.display = "none", n.style.display = "inline-block", c.__setStatus("IDLE"), c.__insertCameraScanImageToScanRegion()
                })["catch"](function(b) {
                    b.disabled = !1, c.__setStatus("ERROR", a.STATUS_WARNING), c.__setHeaderMessage(b, a.STATUS_WARNING)
                });
            });
        }
    }, {
        ...
        value: function(b, c) {
			...
			d.style.display = "none";
            switch (d.innerHTML = b, d.style.display = "none", c) {
                case a.STATUS_SUCCESS:
                    d.style.background = "#6aaf5042", d.style.color = "#477735";
                    break;
                case a.STATUS_WARNING:
        ...
        value: function() {
            ...
            }, this.cameraScanImage.width = 64, this.cameraScanImage.style.opacity = .3, this.cameraScanImage.src = a.ASSET_CAMERA_SCAN, this.cameraScanImage.style.display = "none")
        }
    }, {
